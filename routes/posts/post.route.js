...
const { add_post, get_all_posts_by_user, delete_post, get_post,get_all_posts } = require('../../controllers/posts/post.controller');
const router_post = express.Router();

router_post.route('/post').post(check_token,add_post).get(check_token,get_all_posts)
